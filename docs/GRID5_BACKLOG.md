...
| Grid 5 oversight checks | `3724789`-`3724798` | `3724789`-`3724794` completed cleanly. `3724795`-`3724798` remain pending by `BeginTime`, so partition broadening would not help. | Logs `logs/grid5_watch_<jobid>.out/.err` and last messages |
