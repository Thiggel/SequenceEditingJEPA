...
| Grid 5 oversight checks | `3724789`-`3724798` | `3724789`, `3724790`, `3724791`, and `3724792` completed cleanly. `3724793` started at 2026-06-13 22:50 CEST on `a100mig` node `a0605`; `3724794`-`3724798` remain pending by `BeginTime`, so partition broadening would not help. | Logs `logs/grid5_watch_<jobid>.out/.err` and last messages |
