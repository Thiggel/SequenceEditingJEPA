...
| `3711931_[0-3]` | RUNNING | Grid 4M L3 span-4 hierarchical value ablation. Started at 2026-06-10 11:42:19 CEST on `a0632`/`a0633`; still running at 08:17 CEST with empty stderr. Learned-score reset diagnostics solve `0/128` for every variant; reset-every-4 mean remaining Hamming is terminal energy `47.70`, action advantage `53.62`, state value `49.73`, contrastive margin `43.88`. Oracle latent-goal reset/calibration solves `128/128` for all four. Partial latent-goal subgoal CEM outputs now exist: terminal energy `0/32`, terminal `0/32`, mean remaining Hamming `49.44`; state value `0/32`, terminal `0/32`, mean remaining Hamming `48.75`; contrastive margin `0/32`, terminal `0/32`, mean remaining Hamming `49.59`. Action-advantage latent-goal subgoal output and terminal/state/contrastive learned top-score subgoal outputs are still pending. |
