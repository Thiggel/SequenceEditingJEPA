...
- Loss: next-embedding MSE plus step-wise SIGReg. SIGReg uses 1024 random
  projections, 17 Epps-Pulley knots over `[0, 3]`, and weight `0.1`.
...
- Inner planners: greedy one-step, beam search, best-first/weighted A*,
  categorical CEM, sequence local search, UCT-MCTS.
